...
var inviteInvisible = document.getElementById("invite-invisible");
...
function activerBtnNouvellePartie() {
    ...
    btnInvite.removeEventListener("click", removeButton());
    if (!document.getElementById("i-debut").classList.contains("hidden")) {
        document.getElementById("i-debut").classList.add("hidden");
        document.getElementById("p-debut").classList.add("hidden");
    }
    init();
}
...
document.getElementById("btn-invite").addEventListener("click", function () {
    guestName = prompt("Nom de l'invité");
    if (guestName == null || guestName == "") {
        guestName = "Anonyme";
    }
    document.getElementById("invite").innerHTML = guestName;
